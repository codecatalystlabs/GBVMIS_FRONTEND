...
export function SettingsForm() {
  ...
  return (
    ...
    >
      <TabsList className="grid w-full grid-cols-4 md:w-auto bg-white border border-blue-200 rounded-md">
        <TabsTrigger
          type="button"
          value="profile"
        ...
        <Card className="bg-white border border-gray-200">
          ...
          <CardContent className="space-y-6">
            <div className="flex flex-col items-center space-y-2 sm:flex-row sm:space-x-4 sm:space-y-0">
              <Avatar className="h-24 w-24 border border-blue-200">
                <AvatarImage
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea
                          ...
                          className="resize-none border-blue-200 focus:border-blue-600"
                          {...field}
                        />
                      </FormControl>
